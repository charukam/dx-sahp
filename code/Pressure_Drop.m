%% Pressure Drop in DX-SAHP (Based on R410a)
%clear; clc;
...
for i = 1:num_sec
    rho(i) = py.CoolProp.CoolProp.PropsSI('D', 'T', T(i), 'Q', Q(i), 'R410a'); % Density [kg/m^3]
    mu(i) = py.CoolProp.CoolProp.PropsSI('V', 'T', T(i), 'Q', Q(i), 'R410a'); % Viscosity [Pas]
...
legend("1/2 inch", "3/4 inch", "1 inch");
xlabel("Section");
